      ...
      <div className="mt-12 bg-gray-50 rounded-xl p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          <div>
            ...
            <h3 className="font-medium text-gray-900 mb-1">With Respect</h3>
          ...
          <div>
            ...
            <h3 className="font-medium text-gray-900 mb-1">With Heart</h3>
            <p className="text-sm text-gray-600">
          ...
          <div>
            <div className="text-3xl mb-2">🌱</div>
            <h3 className="font-medium text-gray-900 mb-1">For Growth</h3>
            <p className="text-sm text-gray-600">
